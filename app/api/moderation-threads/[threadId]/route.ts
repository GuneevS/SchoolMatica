  ...
  try {
    ...
    const thread = await prisma.moderationThread.findUnique({
      ...
      include: {
        ...
        assessment: { include: { assessmentPlan: { include: { classGroup: true } } } },
      },
    });
    ...
    return handleApiError("GET moderation-threads/[threadId]", error);
  }
}
...
export async function PATCH(request: NextRequest, { params }: Params) {
  ...
  try {
    ...
    return handleApiError("PATCH moderation-threads/[threadId]", error);
  }
}
