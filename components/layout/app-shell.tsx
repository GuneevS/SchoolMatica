...
export function AppShell({ children, initialSchool, isSuperAdmin: isSuperAdminProp = false, user }: Props) {
  ...
  return (
    <div className="relative flex min-h-screen bg-canvas text-foreground">
      ...
      {/* ---- Desktop Sidebar ---- */}
      <aside className="relative z-10 hidden w-72 flex-col border-r border-[hsl(var(--border-strong))/0.6] bg-[hsl(var(--surface-strong))/0.95] px-5 py-8 shadow-ambient-sm backdrop-blur lg:flex">
