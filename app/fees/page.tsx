...
const mockFeeStructures = [
  {
    id: "1",
    name: "Grade 10 Annual Fees 2024",
    grade: 10,
    baseAmount: 15000,
    students: 45,
    collected: 487500,
  ...
  {
    id: "2",
    name: "Grade 11 Annual Fees 2024",
    grade: 11,
    baseAmount: 16500,
    students: 42,
    collected: 520000,
  ...
  {
    id: "3",
    name: "Grade 12 Annual Fees 2024",
    grade: 12,
    baseAmount: 18000,
    students: 38,
    collected: 612000,
...
export default function FeesPage() {
  ...
  const totalCollected = mockInvoices.reduce((sum, inv) => sum + inv.paid, 0);
  const totalOutstanding = mockInvoices.reduce((sum, inv) => sum + inv.balance, 0);
        ...
        aside={
          <HeroMetricPanel
            ...
            metrics={[
              ...
              { label: "Overdue", value: mockInvoices.filter(i => i.status === "Overdue").length.toString() },
            ]}
          />
        }
      />
        ...
        <TabsContent value="overview">
          ...
          <Card className="mb-6">
            <CardHeader>
              ...
              <CardDescription>Term 1 2024 collection progress</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-6">
                {mockFeeStructures.map((structure) => {
                  const total = structure.collected + structure.outstanding;
                  const percent = (structure.collected / total) * 100;
                  return (
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  {mockInvoices.filter((inv) => inv.status === "Overdue").length === 0 && (
        ...
        <TabsContent value="discounts">
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                {[
                  { name: "Sibling Discount", type: "10% off", applied: 12, desc: "For families with multiple children" },
                  { name: "Staff Child Discount", type: "50% off", applied: 8, desc: "For children of school employees" },
                  { name: "Merit Bursary", type: "R2,500 off", applied: 5, desc: "Academic excellence award" },
                  { name: "Financial Aid", type: "Variable", applied: 15, desc: "Based on financial assessment" },
                ].map((discount, i) => (
                  <div key={i} className="flex items-center justify-between p-4 border rounded-lg">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">{discount.desc}</p>
                      </div>
                    </div>
